...
public class AegisXMLStreamDataReader extends org.jrubycxf.aegis.AbstractAegisIoImpl implements AegisReader<XMLStreamReader> {

    private static final Logger LOG = LogUtils.getL7dLogger(AegisXMLStreamDataReader.class);

    public AegisXMLStreamDataReader(org.jrubycxf.aegis.AegisContext globalContext) {
        super(globalContext);
    }
