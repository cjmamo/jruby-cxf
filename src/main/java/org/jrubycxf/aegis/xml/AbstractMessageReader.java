 ...
 */
public abstract class AbstractMessageReader implements org.jrubycxf.aegis.xml.MessageReader {
    ...
    private void readToEnd(org.jrubycxf.aegis.xml.MessageReader childReader) {
    ...
    public boolean isXsiNil() {
        org.jrubycxf.aegis.xml.MessageReader nilReader = getAttributeReader(XSI_NIL);
        boolean nil = false;
        if (nilReader != null) {
    ...
    /**
     * @see org.jrubycxf.aegis.xml.MessageReader#getValueAsCharacter()
     */
    ...
    /**
     * @see org.jrubycxf.aegis.xml.MessageReader#getValueAsLong()
     */
    ...
    /**
     * @see org.jrubycxf.aegis.xml.MessageReader#getValueAsDouble()
     */
    ...
    /**
     * @see org.jrubycxf.aegis.xml.MessageReader#getValueAsFloat()
     */
    ...
    /**
     * @see org.jrubycxf.aegis.xml.MessageReader#getValueAsBoolean()
     */
