...
public interface TypeCreator {
    ...
    org.jrubycxf.aegis.type.AegisType createType(Method m, int index);

    org.jrubycxf.aegis.type.AegisType createType(PropertyDescriptor pd);
    
    org.jrubycxf.aegis.type.AegisType createType(Type type);

    org.jrubycxf.aegis.type.AegisType createType(Field f);
     ...
     * @return
     */
    org.jrubycxf.aegis.type.AegisType createTypeForClass(TypeClassInfo info);
}
