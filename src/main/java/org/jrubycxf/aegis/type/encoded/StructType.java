...
public class StructType extends BeanType {
    ...
    protected void writeProperty(QName name,
        ...
        if (property instanceof org.jrubycxf.aegis.type.encoded.SoapRef) {
            org.jrubycxf.aegis.type.encoded.SoapRef soapRef = (org.jrubycxf.aegis.type.encoded.SoapRef) property;
     ...
     */
    private final class WritePropertyAction implements org.jrubycxf.aegis.type.encoded.SoapRef.Action {
        ...
        public void onSet(org.jrubycxf.aegis.type.encoded.SoapRef ref) {
