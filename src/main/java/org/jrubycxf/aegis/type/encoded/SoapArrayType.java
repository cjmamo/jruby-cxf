 ...
 * under the License.
 */
package org.jrubycxf.aegis.type.encoded;
...
import org.jrubycxf.aegis.type.TypeMapping;
...
import static org.jrubycxf.aegis.type.encoded.SoapEncodingUtil.readAttributeValue;
...
public class SoapArrayType extends AegisType {
    ...
    public Object readObject(MessageReader reader, Context context) throws DatabindingException {
        try {
            ...
            org.jrubycxf.aegis.type.encoded.ArrayTypeInfo arrayTypeInfo = new org.jrubycxf.aegis.type.encoded.ArrayTypeInfo(reader, tm);
    ...
    protected List<Object> readCollection(MessageReader reader,
            Context context,
            org.jrubycxf.aegis.type.encoded.ArrayTypeInfo arrayTypeInfo,
        ...
        while (reader.hasMoreElementReaders()) {
            ...
            compType = new org.jrubycxf.aegis.type.encoded.SoapRefType(compType);
    ...
    protected Object makeArray(List<Object> values, List<Integer> dimensions, Class<?> componentType) {
        ...
        for (int i = 0; i < values.size(); i++) {
            ...
            if (value != null) {
                org.jrubycxf.aegis.type.encoded.SoapRef soapRef = (org.jrubycxf.aegis.type.encoded.SoapRef) value;
    ...
    public void writeObject(Object values,
        ...
        org.jrubycxf.aegis.type.encoded.ArrayTypeInfo arrayTypeInfo = new ArrayTypeInfo(rootType,
                getDimensions() - 1,
     ...
     *
     * @see org.jrubycxf.aegis.type.AegisType#isComplex()
     */
    @Override
     ...
     */
    private static class SetArrayAction implements org.jrubycxf.aegis.type.encoded.SoapRef.Action {
