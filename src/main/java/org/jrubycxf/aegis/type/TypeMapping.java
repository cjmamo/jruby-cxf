...
public interface TypeMapping {
     ...
     */
    void register(Type javaType, QName xmlType, org.jrubycxf.aegis.type.AegisType type);

    /**
     * Register a type that self-describes the schema type and the Java class.
     * @param type Aegis type object that 
     */
    void register(org.jrubycxf.aegis.type.AegisType type);

    void removeType(org.jrubycxf.aegis.type.AegisType type);

    org.jrubycxf.aegis.type.AegisType getType(Type javaType);

    org.jrubycxf.aegis.type.AegisType getType(QName xmlType);
