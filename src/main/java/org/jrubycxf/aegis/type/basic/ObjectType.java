...
public class ObjectType extends AegisType {
    ...
    public void writeObject(Object object, MessageWriter writer, Context context)
        ...
        if (null == object) {
            ...
            boolean nextIsBeanType = type instanceof org.jrubycxf.aegis.type.basic.BeanType;
            if (nextIsBeanType) {
                ((org.jrubycxf.aegis.type.basic.BeanType)type).writeObjectFromObjectType(object, writer, context, true);
            } else {
