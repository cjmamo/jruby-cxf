    ...
    private void initializeProperties() {
        ...
        try {
            if (beanClass.isInterface() || beanClass.isPrimitive()) {
                ...
                // do nothing
            } else if (beanClass == RubyObject.class || beanClass == Object.class || beanClass == Throwable.class) {
                // do nothing
            ...
            } else if (RubyObject.class.isAssignableFrom(beanClass)) {
                beanInfo = Introspector.getBeanInfo(beanClass, RubyObject.class);
            } else {
