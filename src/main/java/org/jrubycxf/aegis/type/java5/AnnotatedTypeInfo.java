...
public class AnnotatedTypeInfo extends BeanTypeInfo {
    private final org.jrubycxf.aegis.type.java5.AnnotationReader annotationReader;

    public AnnotatedTypeInfo(TypeMapping tm, Class<?> typeClass, 
                             String ns, TypeCreationOptions typeCreationOptions) {
        this(tm, typeClass, ns, new org.jrubycxf.aegis.type.java5.AnnotationReader(), typeCreationOptions);
    }

    public AnnotatedTypeInfo(TypeMapping tm, Class<?> typeClass, String ns, org.jrubycxf.aegis.type.java5.AnnotationReader annotationReader,
