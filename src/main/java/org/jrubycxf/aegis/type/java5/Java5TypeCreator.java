...
import org.jrubycxf.aegis.type.TypeClassInfo;
...
public class Java5TypeCreator extends AbstractTypeCreator {
    ...
    private org.jrubycxf.aegis.type.java5.AnnotationReader annotationReader;

    public Java5TypeCreator() {
        this(new org.jrubycxf.aegis.type.java5.AnnotationReader());
    }

    public Java5TypeCreator(org.jrubycxf.aegis.type.java5.AnnotationReader annotationReader) {
    ...
    public AegisType createEnumType(TypeClassInfo info) {
        org.jrubycxf.aegis.type.java5.EnumType type = new EnumType();
