...
import org.jrubycxf.aegis.AegisXMLStreamDataReader;
...
public class XMLStreamDataReader implements DataReader<XMLStreamReader> {
    ...
    private org.jrubycxf.aegis.databinding.AegisDatabinding databinding;
    private AegisXMLStreamDataReader reader;
    
    public XMLStreamDataReader(org.jrubycxf.aegis.databinding.AegisDatabinding databinding, Bus bus) {
    ...
    public Object read(MessagePartInfo part, XMLStreamReader input) {
        try {
            AegisType type = part.getProperty("org.jrubycxf.aegis.outerType", AegisType.class);
            if (type == null) {
