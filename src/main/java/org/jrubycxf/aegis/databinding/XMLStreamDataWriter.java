...
public class XMLStreamDataWriter implements DataWriter<XMLStreamWriter> {
    ...
    private static final Logger LOG = LogUtils.getL7dLogger(org.jrubycxf.aegis.databinding.XMLStreamDataReader.class);
    ...
    public void write(Object obj, MessagePartInfo part, XMLStreamWriter output) {
        ...
        if (part != null) {
            outerType = part.getProperty("org.jrubycxf.aegis.outerType", AegisType.class);
        }
        try {
            if (obj == null) {
