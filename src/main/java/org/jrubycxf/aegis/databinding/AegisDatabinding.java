...
import org.jrubycxf.aegis.AegisContext;
import org.jrubycxf.aegis.DatabindingException;
import org.jrubycxf.aegis.type.*;
import org.jrubycxf.aegis.type.basic.ArrayType;
import org.jrubycxf.aegis.type.java5.AnnotationReader;
 ...
 * {@link #setAegisContext(org.jrubycxf.aegis.AegisContext)} <i>before</i> any call to {@link #initialize(org.apache.cxf.service.Service)}. That does
 * not require special arrangements; the service factories do not call {{@link #initialize(org.apache.cxf.service.Service)} until
 ...
 *
 * @see org.jrubycxf.aegis.AegisContext
 */
        ...
        if (type == null) {
            ...
            if (param.getMessageInfo().getOperation().isUnwrapped() && param.getTypeClass().isArray()
                ...
                if ((type instanceof ArrayType) && !type.isWriteOuter()) {
                    param.setProperty("org.jrubycxf.aegis.outerType", type);
